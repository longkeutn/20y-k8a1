...
export const INITIAL_RSVP_LIST: RsvpData[] = [
  ...
  },
  {
    ...
    fundAuditedBy: 'Admin',
    fundNote: 'Đóng 700k + Ủng hộ thêm quỹ lớp 300k'
  },
  {
    id: '4',
  ...
  },
  {
    ...
    className: 'K8A1',
    shirtSize: 'XL',
    message: 'Đã hoàn thành chuyển khoản 700k tạm ứng cho Ban Tổ Chức!',
...
export const DEFAULT_EVENT_CONFIG: EventConfig = {
  ...
  letterParagraph2: "Hãy tạm gác lại những bộn bề âu lo, cùng trở về Trung Tâm Sự Kiện & Nhà Hàng Prime Thái Nguyên để gặp lại những gương mặt thanh xuân năm nào, cùng viết tiếp câu chuyện tình bạn đẹp đẽ của Lớp K8A1 chúng mình!",
